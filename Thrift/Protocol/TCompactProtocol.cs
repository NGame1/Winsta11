...
namespace Thrift.Protocol
{
    ...
    public class TCompactProtocol : TProtocol
    {
        ...
        {
            cancellationToken.ThrowIfCancellationRequested();
            BinaryEncoding.Binary.LittleEndian.Set(BitConverter.DoubleToInt64Bits(d), PreAllocatedBuffer);
        ...
        public override async Task WriteStringAsync(string str, CancellationToken cancellationToken)
        {
            ...
            var buf = new byte[Encoding.UTF8.GetByteCount(str)]/*ArrayPool<byte>.Shared.Rent(Encoding.UTF8.GetByteCount(str))*/;
            try
            {
        ...
        public override async ValueTask<double> ReadDoubleAsync(CancellationToken cancellationToken)
        {
           ...
           return BinaryEncoding.Binary.LittleEndian.GetInt64( PreAllocatedBuffer);
        ...
        public override async ValueTask<string> ReadStringAsync(CancellationToken cancellationToken)
        {
            ...
            var buf =new byte[length] /*ArrayPool<byte>.Shared.Rent(length)*/;
            try
            {
