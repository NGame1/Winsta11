...
namespace ViewModels.Profiles
{
    public class UserProfileViewModel : BaseViewModel
    {
        ...
        {
            var UserFollowingsView = AppCore.Container.GetService<IUserFollowingsView>();
            NavigationService.Navigate(UserFollowingsView, User.Pk);
        }

        void NavigateToFollowers()
        {
            var UserFollowersView = AppCore.Container.GetService<IUserFollowersView>();
            NavigationService.Navigate(UserFollowersView, User.Pk);
        }
        ...
        {
            SetHeader();
            if (NavigationService.Content is Page page && page is IUserProfileView)
            {
